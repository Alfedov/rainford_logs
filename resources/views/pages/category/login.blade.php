	...
	<div class="nk-block nk-block-lg">
      <div class="nk-block-head">
          <div class="nk-block-head-content">
              <h4 class="nk-block-title">Входы/выходы</h4>
          </div>
      </div>
                  ...
                  <thead>
                      <tr class="nk-tb-item nk-tb-head">
						 <th class="nk-tb-col"><span class="sub-text">ID</span></th>
                          ...
                          <th class="nk-tb-col tb-col-mb"><span class="sub-text">Тип</span></th>
						  <th class="nk-tb-col tb-col-md"><span class="sub-text">Время</span></th>								  
