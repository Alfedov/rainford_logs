	...
	<div class="nk-block nk-block-lg">
      <div class="nk-block-head">
          <div class="nk-block-head-content">
              <h4 class="nk-block-title">Ответы на репорт</h4>
          </div>
      </div>
                  ...
                  <thead>
                      <tr class="nk-tb-item nk-tb-head">
						 <th class="nk-tb-col"><span class="sub-text">ID</span></th>
                          ...
                          <th class="nk-tb-col tb-col-mb"><span class="sub-text">NickName Admin</span></th>
                          <th class="nk-tb-col tb-col-md"><span class="sub-text">Вопрос</span></th>
						  <th class="nk-tb-col tb-col-md"><span class="sub-text">Ответ</span></th>								  
                  ...
                  <tbody>
                      ...
                      <tr class="nk-tb-item">
						<td class="nk-tb-col tb-col-md">
						  ...
						  <td class="nk-tb-col tb-col-lg">
							<span class="tb-amount">Test</span>
						  </td>
						  <td class="nk-tb-col tb-col-lg">
